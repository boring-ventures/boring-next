...
const socialLinks = [
  ...
  },
  {
    id: "instagram",
    name: "Instagram",
    href: "https://instagram.com/minka",
...
export default function Footer() {
  return (
    <footer className="bg-[#2F855A] text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <nav className="grid gap-2">
            <Link href="/centro-de-ayuda" className="hover:text-white/80">
              Centro de ayuda
            </Link>
            <Link href="/donar" className="hover:text-white/80">
              Donar
            </Link>
            <Link href="/mas-recursos" className="hover:text-white/80">
              Más recursos
            </Link>
        ...
        <div className="mt-12 pt-8 border-t border-white/20 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/60 text-sm">
            © {new Date().getFullYear()} Minka. Todos los derechos reservados.
          </p>
          <Link
